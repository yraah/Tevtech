	...
	class TSSProOptions {
		...
		function get_pro_feature_list(){
			return $html = '<ol>
						...
						<li>Display posts by any Taxonomy like category(s), tag(s)</li>
						<li>Order by Name, Id, Date,  Random and Menu order.</li>
						<li>Display image size (thumbnail, medium, large, full and Custom Image Size)</li>
						<li>Visual Composer Add-one.</li>
						<li>All Text color, size and Button Color control.</li>
						<li>Ajax Pagination: Load more, Load on scroll</li>
						<li>Desktop, Tab & Mobile Display Control.</li>
						<li>Front End Submission</li>
						<li>Front End fields control</li>
						<li>Re-captcha on form.</li>
					</ol>
					<p><a href="https://www.radiustheme.com/downloads/wp-testimonial-slider-showcase-pro-wordpress/" class="button button-primary" target="_blank">Get Pro Version</a></p>';
		}
	}
endif;